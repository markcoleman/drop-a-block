...
const EN_MESSAGES: Record<string, string> = {
  ...
  "start.installApp": "Install App",
  "start.installAppDesc": "Add Drop-a-Block to your home screen for full-screen play.",
  "start.shareGame": "Share Game",
  "start.shareGameDesc": "Send this game to a friend in one tap.",
...
const ES_MESSAGES: Partial<Record<string, string>> = {
  ...
  "start.installApp": "Instalar app",
  "start.shareGame": "Compartir juego",
  "menu.help": "Ayuda",
...
const JA_MESSAGES: Partial<Record<string, string>> = {
  ...
  "start.installApp": "アプリをインストール",
  "start.shareGame": "ゲームを共有",
  "menu.help": "ヘルプ",
  "menu.about": "情報",
  "queue.hold": "ホールド",
  "queue.next": "ネクスト"
